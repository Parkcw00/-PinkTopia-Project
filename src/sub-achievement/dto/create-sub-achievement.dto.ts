...
import {  IsInt, IsNotEmpty, IsOptional,  IsNumber,IsISO8601,IsString, IsEnum, IsDateString, IsDate } from 'class-validator'; // 데코레이터 가져오기
...
export class CreateSubAchievementDto extends PickType(SubAchievement, ['expiration_at','achievement_id', 'title', 'conditions', 'mission_type'] as const) {
